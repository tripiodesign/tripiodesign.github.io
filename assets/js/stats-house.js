...
var miembros = datosHouse.results[0].members;
...
function statsPartido() {
  ...
  for (i = 0; i < miembros.length; i++) {
    ...
    if (miembros[i].party == 'R') {
      contRep++;
      votosRep = votosRep + miembros[i].total_votes;
    }else if (miembros[i].party == 'D') {
      contDem++;
      votosDem = votosDem + miembros[i].total_votes;
    }else if (miembros[i].party == 'ID') {
      contInd++;
      votosDem = votosDem + miembros[i].total_votes;
    }

    totalVotos = totalVotos + miembros[i].total_votes;
  }
  console.log('Representantes:');
  console.log('Rep = ' + contRep + ' Dem = ' + contDem + ' Ind = ' + contInd);
  console.log('Votos por partido');
  console.log('R = ' + votosRep + ' D = ' + votosDem + ' I = ' + votosInd);
  
  var pctVotosR = ((votosRep * 100) / totalVotos).toFixed(3);
  var pctVotosD = ((votosDem * 100) / totalVotos).toFixed(3);
...
function compromiso() {
  ...
  // rango a mostrar
  // var rango10 = ((miembros.length * 10) / 100);
  var rango10 = 11;

  var arrMasC = miembros.sort(ascendente).slice(0, rango10);
  console.log('mas comprometidos ' + arrMasC.length);

  var arrMenosC = miembros.sort(descendente).slice(0, rango10);
